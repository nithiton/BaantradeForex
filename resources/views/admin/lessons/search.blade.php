        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <div class="row">
                        <div class="col-8">
                            <form method="get" action="{{ route('admin.lessons.search') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-4">
                            <a class="btn btn-success btn-sm" href="{{ route('admin.lessons.create') }}">
            ...
            <div class="card-body p-0">
                <table class="table table-striped projects">
                    ...
                    <tr>
                        <td>{{ (($lessons->currentPage()-1)*$lessons->perPage())+($index+1) }}</td>
                        <td>{{ $lesson->title }}</td>
                        <td>{{ $lesson->short_content }}</td>
                        ...
                        <td class="project-actions text-right">
                            @if(is_null($lesson->deleted_at))
                                <a class="btn btn-info btn-sm" href="{{ route('admin.lessons.edit',[$lesson->slug]) }}">
                                    <i class="fas fa-pencil-alt"></i>
                                    Edit
                                </a>
                                <a class="btn btn-danger btn-sm delete-record" href="#" data-toggle="modal" data-target="#confirm-modal"
                                   data-url="{!! route('admin.lessons.destroy',[$lesson->slug]) !!}">
