                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputShortContent" name="short_content" class="form-control @error('short_content') is-invalid @enderror"
                                       maxlength="255" value="{{ $errors->any() ? old('short_content') : $post->short_content }}">
                                @error('short_content')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                >{{ $errors->any() ? old('content') : $post->content }}</textarea>
                                @error('content')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="inputAuthor" name="author" class="form-control @error('author') is-invalid @enderror"
                                       autofocus value="{{ $errors->any() ? old('author') : $post->author }}">
                                @error('author')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <!-- Uploaded image area-->
                                <div class="image-area mt-4"><img id="imageResult" src="{{ asset($post->cover_image) }}" alt="" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
                            </div>
                        </div>
                    <div class="col-12">
