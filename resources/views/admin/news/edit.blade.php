        ...
        <div class="row">
            <div class="col ml-4 mr-4">
                <div class="card card-secondary pb-3">
                    ...
                    <form method="post" action="{{ route('admin.news.update',[$new->slug]) }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <!-- Uploaded image area-->
                                <div class="image-area mt-4"><img id="imageResult" src="{{ asset($new->cover_image) }}" alt="" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
                            </div>
                        </div>
                    <div class="col-12">
