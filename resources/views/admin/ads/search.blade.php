        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <div class="row">
                        <div class="col-8">
                            <form method="get" action="{{ route('admin.ads.search') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-4">
                            <a class="btn btn-success btn-sm" href="{{ route('admin.ads.create') }}">
            ...
            <div class="card-body p-0">
                <table class="table table-striped projects">
                    ...
                    <tr>
                        <td>{{ (($ads->currentPage()-1)*$ads->perPage())+($index+1) }}</td>
                        <td>{{ $ad->title }}</td>
                        <td>{{ $ad->url }}</td>
                        ...
                        <td class="project-actions text-right">
                            @if(is_null($ad->deleted_at))
                                <a class="btn btn-info btn-sm" href="{{ route('admin.ads.edit',[$ad->slug]) }}">
                                    <i class="fas fa-pencil-alt"></i>
                                    Edit
                                </a>
                                <a class="btn btn-danger btn-sm delete-record" href="#" data-toggle="modal" data-target="#confirm-modal"
                                   data-url="{!! route('admin.ads.destroy',[$ad->slug]) !!}">
                                    <i class="fas fa-trash"></i>
                                    Delete
                                </a>
                            @else
                                <form method="post" action="{{ route('admin.ads.restore',[$ad->id]) }}">
                                    {{ csrf_field() }}
